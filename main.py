...
# @markdown <center><h4><a href="https://github.com/XronTrix10/Leecher/wiki/INSTRUCTIONS">READ</a> How to use</h4></center>
...
cmd = "git clone https://github.com/XronTrix10/Leecher"
proc = subprocess.run(cmd, shell=True)
cmd = "apt update && apt install ffmpeg aria2"
proc = subprocess.run(cmd, shell=True)
cmd = "pip3 install -r /content/Leecher/requirements.txt"
proc = subprocess.run(cmd, shell=True)
...
with open('/content/Leecher/credentials.json', 'w') as file:
    file.write(json.dumps(credentials))

Working = False

if os.path.exists("/content/Leecher/my_bot.session"):
    os.remove("/content/Leecher/my_bot.session") # Remove previous bot session
    
print("\rStarting Bot....")

!cd /content/Leecher/ && python3 -m colab_leecher #type:ignore
